<%@ Page Title="" Language="C#" MasterPageFile="~/Teachers.Master" AutoEventWireup="true" CodeBehind="UpdateStudent.aspx.cs" Inherits="MisProjectWeb.UpdateStudent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <form id="Form1" runat="server">
        ...
        <asp:Button ID="Button1" runat="server" Text="Update Student" CssClass="btn btn-primary" OnClick="Button1_Click" />
    </form>
